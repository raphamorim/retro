...
ace.define("ace/ext/old_ie",["require","exports","module","ace/lib/useragent","ace/tokenizer","ace/ext/searchbox","ace/mode/text"], (require, exports, module) => {
    ...
    if (typeof document != "undefined" && !document.documentElement.querySelector) {    
        ...
        const qs = (el, selector) => {
            ...
            for (const ch of el.all) {
                if (classNeme) {
                    if (ch.className.includes(classNeme))
                        return ch;
                } else if (attr) {
