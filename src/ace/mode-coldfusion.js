...
ace.define("ace/mode/coldfusion_highlight_rules",["require","exports","module","ace/lib/oop","ace/mode/javascript_highlight_rules","ace/mode/html_highlight_rules"], (require, exports, module) => {
    const oop = require("../lib/oop");
    const JavaScriptHighlightRules = require("./javascript_highlight_rules").JavaScriptHighlightRules;
    const HtmlHighlightRules = require("./html_highlight_rules").HtmlHighlightRules;
    ...
    const ColdfusionHighlightRules = function() {
        ...
        this.$rules.tag[2].token = (start, tag) => {
...
ace.define("ace/mode/coldfusion",["require","exports","module","ace/lib/oop","ace/lib/lang","ace/mode/html","ace/mode/coldfusion_highlight_rules"], (require, exports, module) => {
    const oop = require("../lib/oop");
    const lang = require("../lib/lang");
