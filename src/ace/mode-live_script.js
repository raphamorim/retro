ace.define("ace/mode/live_script_highlight_rules",["require","exports","module","ace/lib/oop","ace/mode/text_highlight_rules"], (require, exports, module) => {
...
ace.define("ace/mode/live_script",["require","exports","module","ace/lib/oop","ace/mode/text","ace/mode/live_script_highlight_rules","ace/mode/folding/cstyle"], (require, exports, module) => {
  const oop = require("../lib/oop");
  const TextMode = require("./text").Mode;
  const LiveScriptHighlightRules = require("./live_script_highlight_rules").LiveScriptHighlightRules;
