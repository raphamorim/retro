...
ace.define("ace/mode/luapage_highlight_rules",["require","exports","module","ace/lib/oop","ace/mode/html_highlight_rules","ace/mode/lua_highlight_rules"], (require, exports, module) => {
    const oop = require("../lib/oop");
    const HtmlHighlightRules = require("./html_highlight_rules").HtmlHighlightRules;
    const LuaHighlightRules = require("./lua_highlight_rules").LuaHighlightRules;
...
ace.define("ace/mode/luapage",["require","exports","module","ace/lib/oop","ace/mode/html","ace/mode/lua","ace/mode/luapage_highlight_rules"], (require, exports, module) => {
    const oop = require("../lib/oop");
    const HtmlMode = require("./html").Mode;
    const LuaMode = require("./lua").Mode;
    const LuaPageHighlightRules = require("./luapage_highlight_rules").LuaPageHighlightRules;
