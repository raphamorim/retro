...
ace.define("ace/mode/folding/markdown",["require","exports","module","ace/lib/oop","ace/mode/folding/fold_mode","ace/range"], (require, exports, module) => {
    const oop = require("../../lib/oop");
    const BaseFoldMode = require("./fold_mode").FoldMode;
    const Range = require("../../range").Range;
    ...
    (function() {
        ...
        this.getFoldWidgetRange = function(session, foldStyle, row) {
            ...
            if (isHeading(row)) {
                ...
                endRow = row - (!token || !["=", "-"].includes(token.value[0]) ? 1 : 2);
...
ace.define("ace/mode/markdown",["require","exports","module","ace/lib/oop","ace/mode/text","ace/mode/javascript","ace/mode/xml","ace/mode/html","ace/mode/markdown_highlight_rules","ace/mode/folding/markdown"], (require, exports, module) => {
    const oop = require("../lib/oop");
    const TextMode = require("./text").Mode;
    const JavaScriptMode = require("./javascript").Mode;
    const XmlMode = require("./xml").Mode;
    const HtmlMode = require("./html").Mode;
    const MarkdownHighlightRules = require("./markdown_highlight_rules").MarkdownHighlightRules;
    const MarkdownFoldMode = require("./folding/markdown").FoldMode;
