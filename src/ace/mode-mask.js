            ...
            this.$rules.no_regex.unshift({
                regex: "[{}]", onMatch(val, state, stack) {
                    ...
                    if (val == "{" && stack.length) {
                        ...
                        if (this.next.includes("string") || this.next.includes("jsx"))
...
ace.define("ace/mode/html_highlight_rules",["require","exports","module","ace/lib/oop","ace/lib/lang","ace/mode/css_highlight_rules","ace/mode/javascript_highlight_rules","ace/mode/xml_highlight_rules"], (require, exports, module) => {
    ...
    const HtmlHighlightRules = function() {
...
ace.define("ace/mode/markdown_highlight_rules",["require","exports","module","ace/lib/oop","ace/lib/lang","ace/mode/text_highlight_rules","ace/mode/javascript_highlight_rules","ace/mode/xml_highlight_rules","ace/mode/html_highlight_rules","ace/mode/css_highlight_rules"], (require, exports, module) => {
    const oop = require("../lib/oop");
    const lang = require("../lib/lang");
    const TextHighlightRules = require("./text_highlight_rules").TextHighlightRules;
    const JavaScriptHighlightRules = require("./javascript_highlight_rules").JavaScriptHighlightRules;
    ...
    const escaped = ch => `(?:[^${lang.escapeRegExp(ch)}\\\\]|\\\\.)*`;
...
ace.define("ace/mode/mask_highlight_rules",["require","exports","module","ace/lib/oop","ace/lib/lang","ace/mode/text_highlight_rules","ace/mode/javascript_highlight_rules","ace/mode/css_highlight_rules","ace/mode/markdown_highlight_rules","ace/mode/html_highlight_rules"], (require, exports, module) => {
    exports.MaskHighlightRules = MaskHighlightRules;

    const oop = require("../lib/oop");
    const lang = require("../lib/lang");
    const TextRules   = require("./text_highlight_rules").TextHighlightRules;
    const JSRules     = require("./javascript_highlight_rules").JavaScriptHighlightRules;
    const CssRules    = require("./css_highlight_rules").CssHighlightRules;
    const MDRules     = require("./markdown_highlight_rules").MarkdownHighlightRules;
    const HTMLRules   = require("./html_highlight_rules").HtmlHighlightRules;

    const token_TAG       = "keyword.support.constant.language";
    const token_COMPO     = "support.function.markup.bold";
    const token_KEYWORD   = "keyword";
    const token_LANG      = "constant.language";
    const token_UTIL      = "keyword.control.markup.italic";
    const token_ATTR      = "support.variable.class";
    const token_PUNKT     = "keyword.operator";
    const token_ITALIC    = "markup.italic";
    const token_BOLD      = "markup.bold";
    const token_LPARE     = "paren.lparen";
    const token_RPARE     = "paren.rparen";
    let const_FUNCTIONS;
    let const_KEYWORDS;
    let const_CONST;
    let const_TAGS;
    ...
    function MaskHighlightRules () {
        ...
        function addJavaScript(name, escape, closeType) {
            const prfx  =  `js-${name}-`;
            const rootTokens = name === "block" ? ["start"] : ["start", "no_regex"];
            add(
                JSRules
                , prfx
                , escape
...
ace.define("ace/mode/mask",["require","exports","module","ace/lib/oop","ace/mode/text","ace/mode/mask_highlight_rules","ace/mode/matching_brace_outdent","ace/mode/behaviour/css","ace/mode/folding/cstyle"], (require, exports, module) => {
    const oop = require("../lib/oop");
    const TextMode = require("./text").Mode;
    const MaskHighlightRules = require("./mask_highlight_rules").MaskHighlightRules;
