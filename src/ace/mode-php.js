...
ace.define("ace/mode/php_highlight_rules",["require","exports","module","ace/lib/oop","ace/lib/lang","ace/mode/doc_comment_highlight_rules","ace/mode/text_highlight_rules","ace/mode/html_highlight_rules"], (require, exports, module) => {
    const oop = require("../lib/oop");
    const lang = require("../lib/lang");
    const DocCommentHighlightRules = require("./doc_comment_highlight_rules").DocCommentHighlightRules;
    const TextHighlightRules = require("./text_highlight_rules").TextHighlightRules;
    ...
    const PhpLangHighlightRules = function() {
        ...
        const builtinFunctionsDeprecated = lang.arrayToMap(
        ...
        const keywordsDeprecated = lang.arrayToMap(
    ...
    const PhpHighlightRules = function() {
        ...
        for (const key in this.$rules)
            this.$rules[key].unshift(...startRules);
...
ace.define("ace/mode/php_completions",["require","exports","module"], (require, exports, module) => {
    const functionMap = {
        "abs": [
            "int abs(int number)",
    ...
    (function() {
        ...
        this.getFunctionCompletions = (state, session, pos, prefix) => {
        ...
        this.getVariableCompletions = (state, session, pos, prefix) => {
        ...
        this.getArrayKeyCompletions = (state, session, pos, prefix) => {
            const line = session.getLine(pos.row).substr(0, pos.column);
...
ace.define("ace/mode/javascript",["require","exports","module","ace/lib/oop","ace/mode/text","ace/mode/javascript_highlight_rules","ace/mode/matching_brace_outdent","ace/range","ace/worker/worker_client","ace/mode/behaviour/cstyle","ace/mode/folding/cstyle"], (require, exports, module) => {
    const oop = require("../lib/oop");
...
ace.define("ace/mode/css_completions",["require","exports","module"], (require, exports, module) => {
    ...
    (function() {
        ...
        this.getPropertyCompletions = (state, session, pos, prefix) => {
        ...
        this.getPropertyValueCompletions = (state, session, pos, prefix) => {
            const line = session.getLine(pos.row).substr(0, pos.column);
...
ace.define("ace/mode/html_completions",["require","exports","module","ace/token_iterator"], (require, exports, module) => {
    ...
    (function() {
        ...
        this.getTagCompletions = (state, session, pos, prefix) => elements.map(element => ({
            value: element,
            meta: "tag",
            score: Number.MAX_VALUE
        }));

        this.getAttributeCompletions = (state, session, pos, prefix) => {
        ...
        this.getAttributeValueCompletions = (state, session, pos, prefix) => {
            const tagName = findTagName(session, pos);
        ...
        this.getHTMLEntityCompletions = (state, session, pos, prefix) => {
...
ace.define("ace/mode/php",["require","exports","module","ace/lib/oop","ace/mode/text","ace/mode/php_highlight_rules","ace/mode/php_highlight_rules","ace/mode/matching_brace_outdent","ace/range","ace/worker/worker_client","ace/mode/php_completions","ace/mode/behaviour/cstyle","ace/mode/folding/cstyle","ace/unicode","ace/mode/html","ace/mode/javascript","ace/mode/css"], (require, exports, module) => {
    const oop = require("../lib/oop");
    const TextMode = require("./text").Mode;
    const PhpHighlightRules = require("./php_highlight_rules").PhpHighlightRules;
    const PhpLangHighlightRules = require("./php_highlight_rules").PhpLangHighlightRules;
    const MatchingBraceOutdent = require("./matching_brace_outdent").MatchingBraceOutdent;
    const Range = require("../range").Range;
    const WorkerClient = require("../worker/worker_client").WorkerClient;
    const PhpCompletions = require("./php_completions").PhpCompletions;
    const CstyleBehaviour = require("./behaviour/cstyle").CstyleBehaviour;
    const CStyleFoldMode = require("./folding/cstyle").FoldMode;
