...
ace.define("ace/mode/razor_highlight_rules",["require","exports","module","ace/lib/oop","ace/lib/lang","ace/mode/doc_comment_highlight_rules","ace/mode/html_highlight_rules","ace/mode/csharp_highlight_rules"], (require, exports, module) => {
    const oop = require("../lib/oop");
    const lang = require("../lib/lang");
    const DocCommentHighlightRules = require("./doc_comment_highlight_rules").DocCommentHighlightRules;
    const HtmlHighlightRules = require("./html_highlight_rules").HtmlHighlightRules;
    ...
    const RazorLangHighlightRules = function() {
        ...
        const processPotentialCallback = (value, stackItem) => {
    ...
    const RazorHighlightRules = function() {
        ...
        for (const key in this.$rules)
            this.$rules[key].unshift(...razorStartRules);
...
ace.define("ace/mode/razor_completions",["require","exports","module","ace/token_iterator"], (require, exports, module) => {
    const TokenIterator = require("../token_iterator").TokenIterator;
    ...
    (function() {
        ...
        this.getShortStartCompletions = (state, session, pos, prefix) => shortHands.map(element => ({
            value: element,
            meta: "keyword",
            score: Number.MAX_VALUE
        }));

        this.getKeywordCompletions = (state, session, pos, prefix) => shortHands.concat(keywords).map(element => ({
            value: element,
            meta: "keyword",
            score: Number.MAX_VALUE
        }));
...
ace.define("ace/mode/razor",["require","exports","module","ace/lib/oop","ace/mode/html","ace/mode/razor_highlight_rules","ace/mode/razor_completions","ace/mode/html_completions"], (require, exports, module) => {
    const oop = require("../lib/oop");
    const HtmlMode = require("./html").Mode;
    const RazorHighlightRules = require("./razor_highlight_rules").RazorHighlightRules;
    const RazorCompletions = require("./razor_completions").RazorCompletions;
    const HtmlCompletions = require("./html_completions").HtmlCompletions;
