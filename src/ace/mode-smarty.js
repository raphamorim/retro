...
ace.define("ace/mode/smarty_highlight_rules",["require","exports","module","ace/lib/oop","ace/mode/html_highlight_rules"], (require, exports, module) => {
    const oop = require("../lib/oop");
    const HtmlHighlightRules = require("./html_highlight_rules").HtmlHighlightRules;

    const SmartyHighlightRules = function() {
        HtmlHighlightRules.call(this);
        const smartyRules = { start: 
           [ { include: '#comments' },
             { include: '#blocks' } ],
          '#blocks': 
        ...
        for (const rule in this.$rules) {
            this.$rules[rule].unshift(...smartyStart);
        }
...
ace.define("ace/mode/smarty",["require","exports","module","ace/lib/oop","ace/mode/html","ace/mode/smarty_highlight_rules"], (require, exports, module) => {
    const oop = require("../lib/oop");
    const HtmlMode = require("./html").Mode;
    const SmartyHighlightRules = require("./smarty_highlight_rules").SmartyHighlightRules;
