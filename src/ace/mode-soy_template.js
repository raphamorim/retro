...
ace.define("ace/mode/soy_template_highlight_rules",["require","exports","module","ace/lib/oop","ace/mode/html_highlight_rules"], (require, exports, module) => {
    const oop = require("../lib/oop");
    const HtmlHighlightRules = require("./html_highlight_rules").HtmlHighlightRules;
    ...
    const SoyTemplateHighlightRules = function() {
        ...
        for (const i in soyRules) {
            if (this.$rules[i]) {
                this.$rules[i].unshift(...soyRules[i]);
            } else {
...
ace.define("ace/mode/soy_template",["require","exports","module","ace/lib/oop","ace/mode/html","ace/mode/soy_template_highlight_rules"], (require, exports, module) => {
    const oop = require("../lib/oop");
    const HtmlMode = require("./html").Mode;
    const SoyTemplateHighlightRules = require("./soy_template_highlight_rules").SoyTemplateHighlightRules;
