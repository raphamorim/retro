...
ace.define("ace/mode/sqlserver_highlight_rules",["require","exports","module","ace/lib/oop","ace/mode/doc_comment_highlight_rules","ace/mode/text_highlight_rules"], (require, exports, module) => {
    const oop = require("../lib/oop");
    ...
    const SqlServerHighlightRules = function() {
        ...
        keywords = keywords.filter((value, index, self) => !logicalOperators.split('|').includes(value) && !builtinFunctions.split('|').includes(value) && !dataTypes.split('|').includes(value));
...
ace.define("ace/mode/folding/sqlserver",["require","exports","module","ace/lib/oop","ace/range","ace/mode/folding/cstyle"], (require, exports, module) => {
    const oop = require("../../lib/oop");
    const Range = require("../../range").Range;
    ...
    (function() {
        ...
        this.getBeginEndBlock = (session, row, column, matchSequence) => {
            const start = {
                row,
...
ace.define("ace/mode/sqlserver",["require","exports","module","ace/lib/oop","ace/mode/text","ace/mode/sqlserver_highlight_rules","ace/range","ace/mode/folding/sqlserver"], (require, exports, module) => {
    const oop = require("../lib/oop");
    const TextMode = require("./text").Mode;
    const SqlServerHighlightRules = require("./sqlserver_highlight_rules").SqlHighlightRules;
    const Range = require("../range").Range;
    const SqlServerFoldMode = require("./folding/sqlserver").FoldMode;
    ...
    (function() {
        ...
        this.getCompletions = (state, session, pos, prefix) => session.$mode.$highlightRules.completions;
