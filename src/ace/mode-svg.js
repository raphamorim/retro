...
ace.define("ace/mode/svg_highlight_rules",["require","exports","module","ace/lib/oop","ace/mode/javascript_highlight_rules","ace/mode/xml_highlight_rules"], (require, exports, module) => {
    const oop = require("../lib/oop");
    const JavaScriptHighlightRules = require("./javascript_highlight_rules").JavaScriptHighlightRules;
    const XmlHighlightRules = require("./xml_highlight_rules").XmlHighlightRules;
...
ace.define("ace/mode/svg",["require","exports","module","ace/lib/oop","ace/mode/xml","ace/mode/javascript","ace/mode/svg_highlight_rules","ace/mode/folding/mixed","ace/mode/folding/xml","ace/mode/folding/cstyle"], (require, exports, module) => {
    const oop = require("../lib/oop");
    const XmlMode = require("./xml").Mode;
    const JavaScriptMode = require("./javascript").Mode;
    const SvgHighlightRules = require("./svg_highlight_rules").SvgHighlightRules;
    const MixedFoldMode = require("./folding/mixed").FoldMode;
    const XmlFoldMode = require("./folding/xml").FoldMode;
    const CStyleFoldMode = require("./folding/cstyle").FoldMode;
