...
ace.define("ace/mode/velocity_highlight_rules",["require","exports","module","ace/lib/oop","ace/lib/lang","ace/mode/text_highlight_rules","ace/mode/html_highlight_rules"], (require, exports, module) => {
    const oop = require("../lib/oop");
    const lang = require("../lib/lang");
    const TextHighlightRules = require("./text_highlight_rules").TextHighlightRules;
    const HtmlHighlightRules = require("./html_highlight_rules").HtmlHighlightRules;
...
ace.define("ace/mode/folding/velocity",["require","exports","module","ace/lib/oop","ace/mode/folding/fold_mode","ace/range"], (require, exports, module) => {
    const oop = require("../../lib/oop");
    const BaseFoldMode = require("./fold_mode").FoldMode;
    const Range = require("../../range").Range;
...
ace.define("ace/mode/velocity",["require","exports","module","ace/lib/oop","ace/mode/html","ace/mode/velocity_highlight_rules","ace/mode/folding/velocity"], (require, exports, module) => {
    const oop = require("../lib/oop");
    const HtmlMode = require("./html").Mode;
    const VelocityHighlightRules = require("./velocity_highlight_rules").VelocityHighlightRules;
    const FoldMode = require("./folding/velocity").FoldMode;
