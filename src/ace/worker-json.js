...
ace.define("ace/mode/json/json_parse",["require","exports","module"], (require, exports, module) => {
    let // The index of the current character
    at;

    let // The current character
    ch;
    ...
    let // Place holder for the value function.
    value;
...
ace.define("ace/mode/json_worker",["require","exports","module","ace/lib/oop","ace/worker/mirror","ace/mode/json/json_parse"], (require, exports, module) => {
    const oop = require("../lib/oop");
